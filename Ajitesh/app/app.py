...
def home():
    if request.method == 'POST':
        original_url = request.form.get('url       if urlparse(original_url).scheme == '':
        ...
        return render_template('home.html',short_urlst + encoded_string)
    return render_template('home.html')



@app.route('/<short_url redirect_short_url(short_url):
